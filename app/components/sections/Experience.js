...
const EXPERIENCES = [
  {
    ...
    year: "2023 - Present",
    description: "Developing and maintaining full-stack web applications using React and Node.js. Collaborating with senior developers to design database schemas and API endpoints."
  },
  {
    role: "Freelance Web Developer",
    company: "Self-Employed",
    year: "2022 - 2023",
    description: "Built custom websites for local businesses using HTML, CSS, JavaScript, and WordPress. Improved website loading speeds by 40%."
  }
];
          ...
          {EXPERIENCES.map((exp, index) => (
            <div key={index} className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
              ...
              <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] glass-card p-6 rounded-2xl hover:-translate-y-1 transition-transform duration-300">
                ...
                <h4 className="font-medium text-gray-700 dark:text-gray-300 mb-4">{exp.company}</h4>
